...
<div class="bs-example">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="app.php"><font color="white">Request an Appointment</font></a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="duedate1.php">Due date Calculator</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
	...
	<div class="container">
		<h2 style="font-family: Josefin Sans;color: #39b54a;">Due-Date Calculator</h2>
		<hr color="#39b54a" size="5">

			<div class="col-xs-12 col-sm-6 col-md-12">

				<div class="col-xs-12 col-sm-12 col-md-4">
				<img src="duedate.jpg" alt="due date" width="100%">
				</div>
				
				<div class="col-xs-12 col-sm-12 col-md-4">
				<p style="font-size: 16px;">The Ovulation Calculator estimates most probable ovulation date as well as other related.<br> The estimations are calculated using information such as the first day of a person's last period and the average length of their menstrual cycles in conjunction with what is known regarding typical biological cycles.<br> This calculator should not be used as a form of birth control.</p>
				<br><br><br><br><br>
				</div>
			</div>

			<div class="col-xs-12 col-sm-12 col-md-12">
			<div style="border-color: #39b54a;background-color:#eee;border-radius:5px;"><br>


				<form method="post" align="center" action="<?php echo $_SERVER["PHP_SELF"];?>">
					<label style="font-size: 30px;color: #39b54a;">Enter the first day of your last menstrual cycle:&nbsp&nbsp&nbsp&nbsp</label><input style="border: solid;border-color: #39b54a;width: 200px;height:50px;" type="date" name="date" ><br><br><br><br>
				<button style="color:#ffffff;background-color: #39b54a;padding:10px;font-size: 20px;">Calculate</button> 
				<br><br><br>
				</form>
	...
	<p><a href="app.php">Request an Appointment</a></p>
